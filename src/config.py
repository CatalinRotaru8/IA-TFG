...
class DeleteLines:
    ...
    porteria_avanzada = "RL,Jugador,País,Posc,Equipo,Comp,Edad,Nacimiento,90 s,GC,PD,TL,TE,GC,PSxG,PSxG/SoT,PSxG+/-,/90,Cmp,Int.,% Cmp,Int.,TI,%deLanzamientos,Long. prom.,Int.,%deLanzamientos,Long. prom.,Opp,Stp,% de Stp,Núm. de OPA,Núm. de OPA/90,DistProm.,Partidos"
    porteros = "RL,Jugador,País,Posc,Equipo,Comp,Edad,Nacimiento,PJ,Titular,Mín,90 s,GC,GC90,DaPC,Salvadas,% Salvadas,PG,PE,PP,PaC,PaC%,TPint,PD,PD,PC,% Salvadas,Partidos"
